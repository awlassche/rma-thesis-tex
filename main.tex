...
\part{Theoretical framework}
	\include{./chapters/Digital_humanities}
	\include{./chapters/Cultural_evolution}
\part{Methodology}
	\include{./chapters/Corpus}
	\include{./chapters/Spelling_normalization}
	\include{./chapters/LDA}
\part{Analysis and results}
	\include{./chapters/Dominant_topics}
	\include{./chapters/Roles_of_literature}
\part{Conclusion}
...
\include{./chapters/appendix/stoplist_original_corpus}
\include{./chapters/appendix/stoplist_INL_corpus}
\include{./chapters/appendix/stoplist_VARD2_corpus}
